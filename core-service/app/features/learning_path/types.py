"""Type definitions for Learning Path generation workflow.

Provides state types and structured output models for the multi-turn
learning path generation workflow with intention clarification.
"""
...
class AgentMode(str, Enum):
    ...
    BASIC = "basic"  # General chat mode
    LPP = "lpp"  # Learning Path Planning mode


class AgentState(MessagesState):
    """Base agent state with conversation history and mode."""
...
class LearningPathState(MessagesState):
    """Legacy state for simple learning path generation."""
    messages: Annotated[Sequence[BaseMessage], add_messages]
    topic: str | None = None
